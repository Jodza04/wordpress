...
function seraph_accel_siteSettInlineDetach($siteId){ return array (
  ...
  array (
    ...
    array (
      ...
      'fileMmDb' => 'C:\\xampp\\htdocs\\wordpress/wp-content/uploads/woocommerce_uploads/1GAmziQ1RMvklDBL1J1G0CQNLQ9TREUD-GeoLite2-Country.mmdb',
    ),
    'viewsCompatGrps' => 
    array (
      0 => 
  ...
  array (
    ...
    array (
      ...
      'items' => 
      array (
        0 => './/*[contains(concat(" ",normalize-space(@class)," ")," wpforms-container ")]',
        1 => './/*[contains(concat(" ",normalize-space(@class)," ")," wfacp_checkout_form ")]',
      ),
    ),
    'earlyPaint' => true,
    'img' => 
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          7 => './/a[contains(concat(" ",normalize-space(@class)," ")," elementor-icon ")]',
          8 => './/a[starts-with(@href,"#grve-")]',
          9 => './/button[contains(concat(" ",normalize-space(@class)," ")," elementskit-menu-toggler ")]',
          10 => './/a[contains(concat(" ",normalize-space(@class)," ")," ajax_add_to_cart ")]',
          11 => './/button[contains(concat(" ",normalize-space(@class)," ")," single_add_to_cart_button ")]',
          12 => './/a[contains(concat(" ",normalize-space(@class)," ")," dt-mobile-menu-icon ")]',
          13 => './/a[contains(concat(" ",normalize-space(@class)," ")," submit ")]',
          14 => './/a[@uk-toggle]',
          15 => './/a[contains(concat(" ",normalize-space(@class)," ")," woodmart-nav-link ")]',
          16 => './/a[contains(concat(" ",normalize-space(@class)," ")," et_pb_video_play ")]',
          17 => './/*[contains(concat(" ",normalize-space(@class)," ")," et-menu ")]/li/a[starts-with(@href,"#")]',
          18 => './/a[contains(concat(" ",normalize-space(@class)," ")," meanmenu-reveal ")]',
          19 => './/*[contains(concat(" ",normalize-space(@class)," ")," wpforms-icon-choices-item ")]',
          20 => './/a[contains(concat(" ",normalize-space(@class)," ")," wd-el-video-link ")]',
          21 => './/*[contains(concat(" ",normalize-space(@class)," ")," product-video-button ")]/a',
        ),
      ),
      'nonCrit' => 
      array (
...
.rokka-loader, .page-preloader-cover, .apus-page-loading, .medizco-preloder, e-page-transition, .loadercontent, .shadepro-preloader-wrap, .tslg-screen, .page-preloader, .pre-loading, .preloader-outer, .page-loader {
	display: none !important;
}
...
@include(WP_CONTENT_DIR . '/plugins/seraphinite-accelerator/cache.php');
?>