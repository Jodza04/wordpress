	...
	return( array(
		...
		'contPr' => array(
			...
			'fresh' => array(
				'smoothAppear' => true,
				'items' => array(
					'.//*[contains(concat(" ",normalize-space(@class)," ")," wpforms-container ")]',
					'.//*[contains(concat(" ",normalize-space(@class)," ")," wfacp_checkout_form ")]',
				),
			),
...
{
	return( 'Mozilla/99999.9 AppleWebKit/9999999.99 (KHTML, like Gecko) Chrome/999999.0.9999.99 Safari/9999999.99 seraph-accel-Agent/2.20.42 ' . ucwords( implode( ' ', Gen::GetArrField( $viewsDeviceGrp, array( 'agents' ), array() ) ) ) );
}
...
function GetExtContents( $url, &$contMimeType = null, $userAgentCmn = true, $timeout = 30, $rememberServerState = true )
{
	...
	if( $userAgentCmn )
		$args[ 'user-agent' ] = 'Mozilla/99999.9 AppleWebKit/9999999.99 (KHTML, like Gecko) Chrome/999999.0.9999.99 Safari/9999999.99 seraph-accel-Agent/2.20.42';
